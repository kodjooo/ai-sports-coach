...
HELP_TEXT = (
    "<b>ℹ️ Что я умею</b>\n\n"
    "🏋️ <b>Тренировки</b>\n"
    "• Персональный план под твою цель, уровень, пол и инвентарь.\n"
    "• Кнопка «▶️ Тренировка»: разминка → упражнения (кнопки повторов/секунд, "
    "ручной ввод, пропуск) → таймер отдыха → заминка → итог с фидбеком.\n"
    "• К каждому упражнению — GIF с техникой; можно заменить упражнение (подберу под твой "
    "инвентарь и уровень) и перенести тренировку на завтра или сдвинуть неделю.\n\n"
    "🍎 <b>Питание</b>\n"
    "• Пришли фото еды или напиши текстом («съел рис с курицей») — посчитаю КБЖУ.\n"
    "• Вижу кухонные весы и этикетку на фото — беру точный вес/КБЖУ с них; для обычной еды "
    "уточняю по базам (USDA/OpenFoodFacts).\n"
    "• Съел не всё — жми ½/⅓/¼; ошибся — «✏️ Исправить» до сохранения или «↩️ Убрать запись» после.\n"
    ...
    "⚙️ <b>Настройки</b> — дни/время, инвентарь, уровень, число упражнений, "
    "цель по питанию, вес, обновить профиль, сброс истории.\n\n"
    "<i>У распознавания еды и чата есть дневной лимит — на обычное использование хватает с запасом.</i>"
)
...
async def settings_reset(cb: CallbackQuery) -> None:
    await cb.message.answer(
        "♻️ Сбросить историю? Удалю профиль, план, тренировки, записи веса, "
        "дневник питания и переписку — и начнём настройку с нуля. Это необратимо.",
