...
TOOLS_HINT = (
    "Если уместно, ты можешь предложить изменение программы через функции "
    "(нагрузка, замена упражнения, время напоминаний, запись веса). Изменения "
    "применяются ТОЛЬКО после подтверждения пользователем кнопкой. Не предлагай "
    "упражнения не из плана/каталога и не меняй ничего молча."
)
