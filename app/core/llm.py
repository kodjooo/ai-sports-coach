            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Разминка (warmup) — РАСШИРЕННАЯ, 5–7 движений (общий разогрев + "
                        "суставная + активация нужных мышц дня); заминка (cooldown) — 4–6 движений "
                        "(растяжка задействованных групп + дыхание). Каждое движение — с новой "
