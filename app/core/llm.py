...
async def generate_plan(
    ...
    system_content = (
        ...
        "G) РАЗМИНКА (warmup): 5–7 движений из списка РАЗМИНКИ, ДИНАМИЧЕСКИЕ, под главные движения дня "
        "(в день приседа/хинжа — ≥2 на таз/заднюю цепь). ЗАМИНКА (cooldown): 4–6 СТАТИЧЕСКИХ растяжек из того же "
        "списка — именно рабочих мышц дня. warmup/cooldown — массивы названий из списка РАЗМИНКИ (дословно).\n"
