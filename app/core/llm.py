            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "составу (упражнения, подходы, повторы/секунды, ощущение) и параметрам клиента. "
                        "Масштабируй по объёму: мало подходов — мало калорий; короткая сессия — "
                        "низкое число (десятки ккал), не завышай. Без якоря на «типичную тренировку». "
