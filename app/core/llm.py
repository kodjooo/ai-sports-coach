...
async def generate_plan(
    ...
    system_content = (
        ...
        "- ТРАВМЫ/БОЛЬ: если у клиента болит или травмирована зона (колено, плечо, спина и т.п.) — "
        "не нагружай её, выбирай безопасные варианты; и ОБЯЗАТЕЛЬНО добавь этой зоне БОЛЬШЕ "
        "разминки в начале и БОЛЬШЕ растяжки в заминке (лишние 1–2 движения на неё), чтобы снизить риск.\n"
        "- РАЗНООБРАЗИЕ: в дне не повторяй одинаковые движения; за неделю НЕ используй одно "
        "и то же упражнение более 2 раз.\n"
        "- БАЛАНС паттернов за неделю: ноги, задняя цепь, толчок И ОБЯЗАТЕЛЬНО ТЯГА — включи "
        "минимум 1 тяговое движение в неделю (тяга/подтягивания есть в списке), плюс кор.\n"
        "- ИНВЕНТАРЬ: если клиенту доступно оборудование (гантели/штанга/тренажёры/блок) — "
        "ИСПОЛЬЗУЙ его для базовых движений, а не только вес тела; выбирай простые безопасные "
        "варианты под уровень.\n"
        "- СЛОЖНОСТЬ: у каждого упражнения в скобках указана сложность N/5. Новичку бери 1–3, "
        "не давай 4–5 (продвинутые/травмоопасные). Ориентируйся на уровень клиента.\n"
        f"- Верни РОВНО по одному дню на КАЖДЫЙ день из списка дней недели ниже, weekday бери оттуда.\n"
