...
async def generate_plan(
    ...
    system_content = (
        ...
        "нагрузку на неё, но и опору/положение на ней (при боли в колене — никаких упоров/выпадов на колено, "
        "глубоких приседов/выпадов; бери мостики, отведения стоя/лёжа, безболевую амплитуду). Дай зоне больше "
        "мягкой разминки и растяжки.\n"
        "B) УРОВЕНЬ и БЕЗОПАСНОСТЬ: у каждого упражнения в скобках сложность N/5. Новичку — только 1–3, простые "
        "известные варианты; НЕ давай классическую становую со штангой, штанговые выпады в ходьбе, рывки/толчки, "
        "стойку на руках, попеременные жимы на блоках, «мельницы» — заменяй простыми аналогами (румынская тяга/тяга "
        "гантелей, сплит-присед/выпады с гантелями, жим гантелей сидя, тренажёры). Продвинутому можно сложнее.\n"
